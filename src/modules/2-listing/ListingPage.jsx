...
import "./Listing.css";
import AllergySelector from "../6-user/components/AllergySelector";
...
const ListingPage = () => {
  ...
  // Apply All / Veg / Non-Veg / Cuisine filter
  const foodFilteredData =
    foodFilter === "all"
      ? filteredData
      : foodFilter === "veg" || foodFilter === "nonveg"
        ? filteredData.filter((vendor) => vendor.foodType === foodFilter)
        : filteredData.filter((vendor) => vendor.category === foodFilter);
  ...
  return (
    ...
    >
      <header className="hero-header">
        <motion.div className="floating-food food-1" animate={floatAnimation}>
          🍔
        </motion.div>
        <motion.div
      ...
      <section className="filters-container">
        ...
        />
        <AllergySelector onFilterChange={setFoodFilter} />
      </section>
        ...
        {!isAuthenticated && (
          <div className="listing-preview-note">
            ...
            <div className="listing-preview-actions">
              <button
                className="listing-login-btn"
                onClick={() => navigate("/login")}
              >
                Login
              </button>
              <button
                className="listing-register-btn"
