  ...
  function handleToggleFavorite(vendor) {
    setLikedIds((current) => {
      ...
      if (next.has(vendor.id)) {
        ...
        handleToggleFavorite._timer = window.setTimeout(
          () => setToast(null),
          1500,
        );
      }
            ...
            <div className="card-image-container">
              ...
              <div
                className={`card-food-type ${
                  vendor.foodType === "veg" ? "veg" : "nonveg"
                }`}
                title={
                  vendor.foodType === "veg" ? "Vegetarian" : "Non-Vegetarian"
                }
                aria-label={
                  vendor.foodType === "veg" ? "Vegetarian" : "Non-Vegetarian"
                }
...
19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
            ...
            <div className="card-content">
              <div className="card-header">
                ...
                <span className="card-rating">★ {vendor.rating}</span>
              </div>
